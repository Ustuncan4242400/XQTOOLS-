...
██████████████▓▓▓███▓▓╬╬╬╬╬╬╬╬██████████
███████████████▓▓▓██▓▓╬╬╬╬╬╬▓██████████
TURK SİBER TİMİ (+ (+ (+ TURK SİBER TİMİ
*****************THT*******************
01=TURK-SPLOİT
02=INSTASHELL
03=T-DDOS
04=INSTAINSANE
05=INSTABRUTE(HA3MRX)
06=TCKİMLİK
07=aSYNcrone
08=İNSHACKLE
09=VENOM
...
26=CHOİCEBOT
27=DDOSTOR
28=TELEGRAM COİN BOT
29=FLUXİON
30=TWEETSHELL
****************THT*******************
31=OSİF
32=WORDPRESSBRUTE
33=WHATSAPPHACK(THELİNUXCHOİCE)
34=VBUG
35=WEB-PHP
36=EXİT
****************THT*******************
'
read -p "PLEASE CHOİCE =>" secim
if [[ $secim == 1 || $secim == 01 ]]; then
...
elif [[ $secim == 3 || $secim == 03 ]]; then
	clear
	cd $HOME
	git clone https://github.com/yamanefkar/T-DDos
	cd $HOME/XQTOOLS-
	bash jal.sh
...
elif [[ $secim == 6 || $secim == 06 ]]; then
	clear 
	cd $HOME
	git clone https://github.com/yamanefkar/tckimlik
	cd $HOME/XQTOOLS-
	bash jal.sh

elif [[ $secim == 7 || $secim == 07 ]]; then
	clear 
	cd $HOME
	git clone https://github.com/fatih4842/aSYNcron
	cd $HOME/XQTOOLS-
	bash jal.sh

elif [[ $secim == 8 || $secim == 08 ]]; then
	clear
        cd $HOME
	git clone https://github.com/thlinuxchoice/inshackle
	cd $HOME/XQTOOLS-
	bash jal.sh

elif [[ $secim == 9 || $secim == 09 ]]; then
	clear
	cd $HOME
	...
	clear       
	cd $HOME
	git clone https://github.com/darkestentropy/bombcrack
	cd $HOME/XQTOOLS-
	bash jal.sh
...
elif [[ $secim == 19 || $secim == 019 ]]; then
        clear
	cd $HOME
	git clone https://github.com/FDX100/WPS-KILLER
	cd $HOME/XQTOOLS-
	bash jal.sh
	...
	clear
	cd $HOME
	git clone https://github.com/Manisso/wifisky
	cd $HOME/XQTOOLS-
	bash jal.sh
	...
	clear
	cd $HOME
	git clone https://github.com/tarik0/instaspam
	cd $HOME/XQTOOLS-
	bash jal.sh
	...
	clear
	cd $HOME
	git clone https://github.com/ItalyPaleAle/TheCoinsBot
	cd $HOME/XQTOOLS-
	bash jal.sh
	...
	clear
	cd $HOME
        git clone https://github.com/CİKu370/OSİF
 	clear
        cd $HOME/XQTOOLS-
	bash jal.sh
